...
export default function ProjectCard({ 
  ...
  // Show only first 3 technologies, add "+X more" if there are more
        ...
        <div className="project-card-content">
          ...
          <div className="project-card-bottom">
            <div className="project-technologies">
              ...
              {remainingCount > 0 && (
                <span className="tech-tag more-tag">+{remainingCount} more</span>
              )}
            </div>
            <div className="project-actions">
              ...
              <div className="project-links">
                ...
                {linkedinUrl && (
                  <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="project-link linkedin-link">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
